      ...
      <div className="mb-3 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 max-w-2xl text-sm text-zinc-400">
            ასლები ინახება Supabase-ში ცალკე ცხრილში. ყოველი შენახვისთანავე (ფილიალი ან ადმინი)
            ავტომატურად იქმნება ბექაპი; ყოველდღე დამატებით 02:00 UTC-ზე. შეგიძლიათ ჩამოტვირთოთ JSON
            კომპიუტერზე ან აღადგინოთ ძველი მდგომარეობა.
          </p>
        </div>
        <button
          type="button"
