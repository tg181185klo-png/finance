...
const MODULES: Module[] = [
  ...
  },
  {
    ...
    description:
      "რა გვეკუთვნება გადასახდელი, რამდენი გადაიხადა და რომელი მეთოდით (ქეში / ბარათი / ანგარიში).",
    status: "ready",
    links: [{ label: "ვალდებულებები", tab: "obligations" }],
    points: [
      "ხელფასი თანამშრომლის სახელით",
      "ყოველთვიური და ერთჯერადი ვალდებულებები",
      "ნაწილ-ნაწილ გასტუმრება",
      "გასტუმრება ავტომატურად იწერს ხარჯს და ანგარიშის მოძრაობას",
    ],
  },
];
...
const CAN_DO = [
  ...
  "ვალდებულებების ციკლი: დარიცხვა → გასტუმრება → აღრიცხვა",
